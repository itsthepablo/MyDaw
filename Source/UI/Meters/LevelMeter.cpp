...
LevelMeter::LevelMeter(Track* t) : track(t)
{
    setOpaque(false);
...
void LevelMeter::setTrack(Track* t)
{
    track = t;
    reset(); 
    if (track != nullptr) startTimerHz(30);
...
void LevelMeter::setSource(MeterSource s) 
{ 
    source = s; 
    reset(); 
}
...
void LevelMeter::setHorizontal(bool horizontal) 
{ 
...
void LevelMeter::updateValueBoxText() 
{
...
void LevelMeter::positionValueBox() 
{
    int w = 48, h = 20;
